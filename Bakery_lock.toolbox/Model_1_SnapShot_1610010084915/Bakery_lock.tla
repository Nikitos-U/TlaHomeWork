...
CriticalSectionInvariant == {pc[1], pc[2]} /= {"criticalSection", "criticalSection"}
                            /\ maxProcResult[1] <= MaxTokenNumber - 1
                            /\ maxProcResult[2] <= MaxTokenNumber - 1
...
MutualExclusion == [] \A proc1, proc2 \in 1..N : (proc1 # proc2) => ~ (pc[proc1] = "criticalSection" /\ pc[proc2] = "criticalSection")
NoDeadlock == (\A proc1 \in 1..N : pc[proc1] = "p2") ~> (\E proc2 \in 1..N : pc[proc2] = "criticalSection")
NoStarvation == \A proc \in 1..N : (pc[proc] = "p2") ~> (pc[proc] = "criticalSection") 
=============================================================================
\* Modification History
\* Last modified Thu Jan 07 11:58:25 MSK 2021 by a18535673
